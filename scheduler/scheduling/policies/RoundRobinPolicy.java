...
/**
 * RoundRobinPolicy Class: Represents a policy that uses a FIFO data structure.
...
public class RoundRobinPolicy extends Policy {
	...
	/**
	 * This field is an integer that represents the quantum time. This time is used to execute all the processes.
	 */
	private int quantumTime;

	/**
	 * Initializes the policy with the quantum time received as parameter.
	 * @param quantumTime: This field is an integer that represents the quantum time. This time is used to execute all the processes.
	 */
	public RoundRobinPolicy(int quantumTime) {
		this.quantumTime = quantumTime;
	}

	/**
	 * Returns the quantum time.
