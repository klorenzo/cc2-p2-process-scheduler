...
/**
 * ArithmeticProcess Class: Represents an Arithmetic operation.
 * @author Kevin Lorenzo
 */
public class ArithmeticProcess extends SimpleProcess implements ComplexProcess {

	/**
	 * This field is a String Constant that represents the process type. For this type of process, the string "A" is used.
	 */
	 ...
	 */
	public ArithmeticProcess(int id, int priority, int processingTime) {
		super(id);
