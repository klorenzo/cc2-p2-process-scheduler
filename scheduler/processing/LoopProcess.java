...
/**
 * LoopProcess Class: Represents an Iterative operation.
 * @author Kevin Lorenzo
 */
public class LoopProcess extends SimpleProcess implements ComplexProcess {

	/**
	 * This field is a String Constant that represents the process type. For this type of process, the string "L" is used.
	 */
	 ...
	 */
	public LoopProcess(int id, int priority, int processingTime) {
		super(id);
